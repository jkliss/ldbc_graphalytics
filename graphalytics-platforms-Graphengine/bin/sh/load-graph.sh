...
cd ~/Git/GraphEngineBenchmark/BenchmarkClient/
COMMAND="dotnet run load \
  --input-vertex-path $INPUT_VERTEX_PATH \
  --input-edge-path $INPUT_EDGE_PATH \
  --graph-name $GRAPH_NAME \
  --eoutput-path $OUTPUT_PATH \
  --weighted $WEIGHTED \
  --directed $DIRECTED"
