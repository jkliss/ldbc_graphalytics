 ...
 */
package science.atlarge.graphalytics.Graphengine.algorithms.pr;
...
/**
 * Page Rank job implementation for Graphengine. This class is responsible for formatting PR-specific
 * arguments to be passed to the platform executable, and does not include the implementation of the algorithm.
 *
 * @author Julius Kliss
 */
public final class PageRankJob extends GraphengineJob {
	 ...
	 */
	public PageRankJob(RunSpecification runSpecification, GraphengineConfiguration platformConfig,
