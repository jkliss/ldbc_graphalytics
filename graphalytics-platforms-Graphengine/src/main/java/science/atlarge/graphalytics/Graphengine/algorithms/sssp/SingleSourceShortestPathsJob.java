 ...
 */
package science.atlarge.graphalytics.Graphengine.algorithms.sssp;
...
/**
 * Single Source Shortest Paths job implementation for Graphengine. This class is responsible for formatting SSSP-specific
 * arguments to be passed to the platform executable, and does not include the implementation of the algorithm.
 *
 * @author Julius Kliss
 */
public final class SingleSourceShortestPathsJob extends GraphengineJob {
	...
	public SingleSourceShortestPathsJob(RunSpecification runSpecification,
										GraphengineConfiguration platformConfig,
