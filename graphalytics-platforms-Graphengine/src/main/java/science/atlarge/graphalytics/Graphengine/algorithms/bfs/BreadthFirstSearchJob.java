 ...
 */
package science.atlarge.graphalytics.Graphengine.algorithms.bfs;
...
/**
 * Breadth-first Search job implementation for Graphengine. This class is responsible for formatting BFS-specific
 * arguments to be passed to the platform executable, and does not include the implementation of the algorithm.
 *
 * @author Julius Kliss
 */
public final class BreadthFirstSearchJob extends GraphengineJob {
	 ...
	 */
	public BreadthFirstSearchJob(RunSpecification runSpecification, GraphengineConfiguration platformConfig,
