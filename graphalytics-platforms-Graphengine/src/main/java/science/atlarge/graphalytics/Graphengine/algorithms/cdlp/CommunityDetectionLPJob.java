 ...
 */
package science.atlarge.graphalytics.Graphengine.algorithms.cdlp;
...
/**
 * Community Detection job implementation for Graphengine. This class is responsible for formatting CDLP-specific
 * arguments to be passed to the platform executable, and does not include the implementation of the algorithm.
 *
 * @author Julius Kliss
 */
public final class CommunityDetectionLPJob extends GraphengineJob {
	 ...
	 */
	public CommunityDetectionLPJob(RunSpecification runSpecification, GraphengineConfiguration platformConfig,
