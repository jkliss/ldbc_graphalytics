 ...
 * @author Julius Kliss
 */
public final class GraphengineConfiguration {

	protected static final Logger LOG = LogManager.getLogger();

	private static final String BENCHMARK_PROPERTIES_FILE = "benchmark.properties";
	private static final String HOME_PATH_KEY = "platform.Graphengine.home";
	private static final String NUM_MACHINES_KEY = "platform.Graphengine.num-machines";
	private static final String NUM_THREADS_KEY = "platform.Graphengine.num-threads";
	...
	/**
	 * Creates a new GraphengineConfiguration object to capture all platform parameters that are not specific to any algorithm.
	 */
	public GraphengineConfiguration(){
	}
	...
	public static GraphengineConfiguration parsePropertiesFile() {

		GraphengineConfiguration platformConfig = new GraphengineConfiguration();
