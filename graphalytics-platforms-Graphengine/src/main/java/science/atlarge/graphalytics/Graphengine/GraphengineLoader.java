 ...
 * @author Julius Kliss
 */
public class GraphengineLoader {

	private static final Logger LOG = LogManager.getLogger();

	protected CommandLine commandLine;
	protected FormattedGraph formattedGraph;
	protected GraphengineConfiguration platformConfig;


	/**
	 *	Graph loader for Graphengine.
	 * @param formattedGraph
	 * @param platformConfig
	 */
	public GraphengineLoader(FormattedGraph formattedGraph, GraphengineConfiguration platformConfig) {
